...
const SignupFormSchema = z.object({
  username: z
    ...
    .min(0, 'Insira seu nome'),
  email: z
    .string({ message: 'Campo obrigatório' })
    .email('Insira um email válido'),
  password: z
    .string({ message: 'Campo obrigatório' })
    .min(0, 'Insira sua senha'),
});
...
GoogleSignin.configure({
  ...
  webClientId:
    '643875255309-poa21bd5hhc7jv2lmnf3pupum7e0khhe.apps.googleusercontent.com',
});
      ...
      <KeyboardAvoidingView behavior='padding' style={{ gap: 20 }}>
        <View style={styles.textfield}>
          ...
          {errors.username?.message && (
            <Text
              style={[styles.text, { color: 'red', alignSelf: 'flex-end' }]}
            >
              {errors.username.message}
            </Text>
          )}
      ...
      <View style={{ gap: 20 }}>
        ...
        >
          <Text style={styles.text}>
            {isLoading ? <ActivityIndicator color='#02084B' /> : 'Criar conta'}
          </Text>
        </TouchableOpacity>
      </View>
